...
#define _persist_VERSION 0.00.6
#endif
...
/* Constants */
 ...
 #define PERSIST_MAI_VARLIST 49U
...
{	struct Persistence_Int_VarInfo_typ WorkingVariableInfo[50];
...
{	unsigned long pPersistentVariable;
	...
	plcstring WorkingVariableList[50][121];
} Persistence_IN_typ;
